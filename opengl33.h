...
typedef   (WINAPI * GLCHECKFRAMEBUFFERSTATUSPROC)(GLenum target);
...
typedef   (WINAPI * GLCLIENTWAITSYNCPROC)(GLsync sync,GLbitfield flags,GLuint64 timeout);
...
typedef   (WINAPI * GLCREATEPROGRAMPROC)();
extern GLCREATEPROGRAMPROC glCreateProgram;

typedef   (WINAPI * GLCREATESHADERPROC)(GLenum type);
...
typedef   (WINAPI * GLFENCESYNCPROC)(GLenum condition,GLbitfield flags);
...
typedef   (WINAPI * GLGETATTRIBLOCATIONPROC)(GLuint program,const GLchar *name);
...
typedef   (WINAPI * GLGETFRAGDATAINDEXPROC)(GLuint program,const GLchar *name);
extern GLGETFRAGDATAINDEXPROC glGetFragDataIndex;

typedef   (WINAPI * GLGETFRAGDATALOCATIONPROC)(GLuint program,const GLchar *name);
...
typedef const  * (WINAPI * GLGETSTRINGPROC)(GLenum name);
extern GLGETSTRINGPROC glGetString;

typedef const  * (WINAPI * GLGETSTRINGIPROC)(GLenum name,GLuint index);
...
typedef   (WINAPI * GLGETUNIFORMBLOCKINDEXPROC)(GLuint program,const GLchar *uniformBlockName);
...
typedef   (WINAPI * GLGETUNIFORMLOCATIONPROC)(GLuint program,const GLchar *name);
...
typedef   (WINAPI * GLISBUFFERPROC)(GLuint buffer);
extern GLISBUFFERPROC glIsBuffer;

typedef   (WINAPI * GLISENABLEDPROC)(GLenum cap);
extern GLISENABLEDPROC glIsEnabled;

typedef   (WINAPI * GLISENABLEDIPROC)(GLenum target,GLuint index);
extern GLISENABLEDIPROC glIsEnabledi;

typedef   (WINAPI * GLISFRAMEBUFFERPROC)(GLuint framebuffer);
extern GLISFRAMEBUFFERPROC glIsFramebuffer;

typedef   (WINAPI * GLISPROGRAMPROC)(GLuint program);
extern GLISPROGRAMPROC glIsProgram;

typedef   (WINAPI * GLISQUERYPROC)(GLuint id);
extern GLISQUERYPROC glIsQuery;

typedef   (WINAPI * GLISRENDERBUFFERPROC)(GLuint renderbuffer);
extern GLISRENDERBUFFERPROC glIsRenderbuffer;

typedef   (WINAPI * GLISSAMPLERPROC)(GLuint sampler);
extern GLISSAMPLERPROC glIsSampler;

typedef   (WINAPI * GLISSHADERPROC)(GLuint shader);
extern GLISSHADERPROC glIsShader;

typedef   (WINAPI * GLISSYNCPROC)(GLsync sync);
extern GLISSYNCPROC glIsSync;

typedef   (WINAPI * GLISTEXTUREPROC)(GLuint texture);
extern GLISTEXTUREPROC glIsTexture;

typedef   (WINAPI * GLISVERTEXARRAYPROC)(GLuint array);
...
typedef   (WINAPI * GLUNMAPBUFFERPROC)(GLenum target);
